...
for version post dbskkd-cdb-1.71dev
...
cdbマージの問題は残っているが，とりあえず作業環境を維持するために
cleanupcdb.sh を追加
...
基本的にCreative Commons BSD License
http://creativecommons.org/licenses/BSD/
に準拠します．

詳しい条件については各ソースファイルを参考にしてください．

本プログラムの配布条件は 1.01, 1.71dev については
skk，skkservと同様 GPLに準拠していました．
...
また，以下の方々には 1.71dev までの
開発にあたって有用な助言をいただきました．
ここに感謝の意を表します(敬称略)．
